...
public class HttpClientKeepSession {
    private static final Logger logger = LoggerFactory.getLogger(HttpClientKeepSession.class);
    ...
    public static void main(String[] args) throws ClientProtocolException, IOException {
        ...
        //用户登陆
        CloseableHttpResponse response = HttpClientKeepSession.post("http://www.weichi.tech/user/login", "username=com&password=26");

        printResponse(response);
        CloseableHttpResponse response2 = HttpClientKeepSession.get("http://www.weichi.tech/dashboardController/index");
